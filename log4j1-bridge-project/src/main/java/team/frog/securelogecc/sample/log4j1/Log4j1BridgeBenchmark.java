package team.frog.securelogecc.sample.log4j1;
...
public class Log4j1BridgeBenchmark {
    public final Logger logger = LoggerFactory.getLogger(getClass());

    public static void main(String[] args) throws Exception {
        new Log4j1BridgeBenchmark().run(args);
    }
    ...
    private void run(String[] args) throws Exception {
        ...
        System.out.println("ENGINE=log4j1-bridge");
    ...
    private static void shutdownLogging() {
        try {
            Class<?> log4j2Manager = Class.forName("org.apache.logging.log4j.LogManager");
            log4j2Manager.getMethod("shutdown").invoke(null);
            return;
